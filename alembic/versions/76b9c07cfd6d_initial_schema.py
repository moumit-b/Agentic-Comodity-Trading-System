...
def upgrade() -> None:
    ...
    op.create_index('idx_bars_agg_symbol_tf_ts', 'bars_aggregated', ['symbol', 'timeframe', 'timestamp'])
    ...
    op.create_index('idx_indicators_symbol_tf_ts', 'indicators', ['symbol', 'timeframe', 'timestamp'])
    ...
    op.create_table(
        ...
        sa.Column('current_pnl', sa.Numeric(precision=15, scale=2), nullable=False, server_default='0.0'),
